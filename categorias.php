...
// Verifica se o parâmetro catId está setado
if (!isset($_GET['catId'])) {
    echo "<div class='header'>";
    echo "Nenhuma categoria foi informada para visualização no container.";
    echo "</div>";
...
$midiasList = $midiasClass->mostrarMidiasCategorias($catId);
